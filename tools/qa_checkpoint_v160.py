...
APK=ROOT/'manual_apk/out/BrainRelaxSoundPerception_v1.6.0.apk'
...
with zipfile.ZipFile(APK) as z:
    ...
    ck('Version name',attrs.get('manifest.versionName')=='1.6.0',str(attrs.get('manifest.versionName')))
    ck('Version code',attrs.get('manifest.versionCode')==10,str(attrs.get('manifest.versionCode')))
...
ck('Localization 233-key extensions','diagRoute' in html and 'openLearn' in html and 'learnLead' in html)
